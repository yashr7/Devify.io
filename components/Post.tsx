            ...
            <div className='p-3 pb-1'>
                ...
                <div className='flex items-center space-x-2'>
                    ...
                    <p className='text-xs text-gray-400'>
                        <span className='font-bold text-black hover:text-blue-400 hover:underline '>r/{post.subreddit[0]?.topic}</span> • Posted by u/{post.username} <ReactTimeAgo date={post.created_at} locale="en-US" />
                    </p>
                </div>
